...
- (void)viewDidLoad {
    ...
    if (self.displayActionRemButton) {
        _actionButton = [[UIBarButtonItem alloc]initWithBarButtonSystemItem:UIBarButtonSystemItemTrash target:self action:@selector(remButtonPressed:)];
    }
...
//删除
- (void)remButtonPressed:(id)sender
{

...
//距离
@property (nonatomic,assign) CGFloat target_YMax;  /**< 监测目标最大值 */
@property (nonatomic,assign) CGFloat target_YMini; /**< 监测目标最小值 */
...
@property (nonatomic, assign) CGFloat chartLine_foot_h;/*x轴下面的高度*/
...
@property (nonatomic, assign) BOOL isMoreLine;/*是否是多曲线*/
@property (nonatomic,assign) BOOL isShowDate; /**< 是否显示具体日期-月日 */
...
@property (nonatomic, strong) NSArray *chartLine_LineColorArr;/*图标线的颜色*/
